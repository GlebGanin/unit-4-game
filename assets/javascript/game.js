...
//SELECT SECOND BOT, CHANGE BOT BORDER COLORS
        ...
        $(document).on('click','.bot2', function() {
                ...
                $("#topbar").html('<img id="attack" src="assets/images/attack.png">');     
                });
...
//ATTACK FUNCTION
        ...
        $(document).on('click','#attack', function(attack) {
                ...
                $('#midpick .botlife').text(newenemypick);
                    ...
                    if (newplayerpick <= 0) {
                        $("#topbar").html('<img src="assets/images/youloose.png">');
                        playerpick = 0;
                    ...
                    if (newenemypick <= 0)  {
                        ...
                        $('#midpick .bot2').remove();
                        $('#midpick .bot3').remove();
                        $('#midpick .bot4').html('<img src="assets/images/win.png">').addClass('win float');
